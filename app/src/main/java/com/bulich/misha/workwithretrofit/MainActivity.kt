    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding?.bottomNav?.setOnItemSelectedListener { item ->
            when(item.itemId) {
                ...
                R.id.genreCatalogBottomNav -> supportFragmentManager.beginTransaction().replace(R.id.content, Panel()).commit()
                R.id.filmsCatalogBottomNav -> supportFragmentManager.beginTransaction().replace(R.id.content, Panel()).commit()
            }
